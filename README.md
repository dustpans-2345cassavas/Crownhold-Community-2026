...
# 🎮 Crownhold — Community Edition

**Rule a medieval kingdom in this standalone strategy build.**
...
Crownhold is a medieval kingdom management strategy game combining settlement building, resource economy, and real-time tactical battles. This Community Edition is a standalone build delivered as a self-contained package with no storefront required. The offline version includes all content and runs without additional software.

This build is for strategy players who want a self-contained, offline version of Crownhold on Windows.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4579940/b1d98d8634d6c67804c5307cc8f3fd0fe16360fa/ss_b1d98d8634d6c67804c5307cc8f3fd0fe16360fa.1920x1080.jpg?t=1786950114" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4579940/d32e5caf0ff5d27775bac60f54ad389bdb0edb1e/ss_d32e5caf0ff5d27775bac60f54ad389bdb0edb1e.1920x1080.jpg?t=1786950114" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4579940/0486503e2007605e0bf9ccbf51efb03507a3f8e4/ss_0486503e2007605e0bf9ccbf51efb03507a3f8e4.1920x1080.jpg?t=1786950114" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Polish, Russian, Simplified Chinese
- **Voiceover:** English
...
- 🏰 **Castle & Settlement Building** — Design and expand strongholds with walls, keeps, and production districts.
- 🌾 **Kingdom Economy** — Balance grain, gold, trade routes, and population growth across seasons.
- ⚔️ **Real-Time Tactical Battles** — Command formations of infantry, cavalry, and siege units on 3D battlefields.
- 🗺️ **Procedural Campaign Maps** — Every campaign generates a unique realm with rival lords and dynamic borders.
- 🤝 **Faction Diplomacy** — Negotiate alliances, trade pacts, and vassalage with AI-controlled houses.
- 🛠️ **Modding Support** — Load community mods through the built-in loader and data folder structure.
- 🎮 **LAN Multiplayer** — LAN or direct connection supported for up to 8 players.
- 📴 **Fully Offline Version** — The complete build runs offline with no account or storefront required.

- **Compression:** Lossless
- **Install Time:** ~10 minutes on SSD, ~25 minutes on HDD
- **Recoding:** none
- **Selective Download:** Optional language packs can be skipped during installation

---

## 📦 DLCs Included

- Crownhold: Northern Marches
- Crownhold: Royal Court
- Crownhold: Siegecraft Pack
...
| **Processor** | Intel Core i5-4460 or AMD FX-6300 | Intel Core i7-8700 or AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 960 or AMD Radeon R9 380, 4 GB VRAM | NVIDIA GeForce GTX 1660 or AMD Radeon RX 5600 XT, 6 GB VRAM |
| **Storage** | 25 GB available space | 25 GB on an SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12, keyboard and mouse |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Crownhold\Saved`
